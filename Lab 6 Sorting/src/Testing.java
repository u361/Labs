...
public class Testing {
    public static void main(String[] args) {
        System.out.println("1 - StupidSort, 2 - BubbleSort, 3 - ShakerSort, 4 - InsertionSort, 5 - SelectionSort, 6 - MergeSort," +
                "7 - QuickSort, 8 - CountSort, 9 - RadixSort, 10 - TreeSort, 11 - HeapSort, 12 - ArraysSort");
